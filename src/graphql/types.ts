...
export type ThreadIdForTimelineEntryQueryVariables = Exact<{
  customerId: Scalars['ID'];
  timelineEntryId: Scalars['ID'];
}>;


export type ThreadIdForTimelineEntryQuery = { __typename?: 'Query', timelineEntry: { __typename?: 'TimelineEntry', threadId: string } | null };
...
export const ThreadIdForTimelineEntryDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"threadIdForTimelineEntry"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"customerId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"timelineEntryId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"timelineEntry"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"customerId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"customerId"}}},{"kind":"Argument","name":{"kind":"Name","value":"timelineEntryId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"timelineEntryId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"threadId"}}]}}]}}]} as unknown as DocumentNode<ThreadIdForTimelineEntryQuery, ThreadIdForTimelineEntryQueryVariables>;
